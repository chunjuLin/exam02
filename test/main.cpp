...
RPCFunction Gesture_ui(&gesture_ui, "capture");
...
void ML(){
    ...
    while (1) {
        if (stop_gesture == 0){
            ...
            if(gesture_index != 3){
                gesture_id[gesture_num] = gesture_index;
                gesture_num++;
            }
            ...
            if (gesture_index < label_num){
                ...
                else if(gesture_index == 2 && threshold_angel > 30)threshold_angel -= 5;
            }
